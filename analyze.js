...
function main(params) {
    ...
    /*------START OF FIRST CODE SNIPPET WE ADDED------*/
    params["__bx_creds"] = params.credentials;
    ...
    /*------END OF FIRST CODE SNIPPET WE ADDED--------*/
  ...
  return new Promise((resolve, reject) => {
    ...
    try {
      ...
      /*------START OF SECOND CODE SNIPPET WE ADDED AND CHANGED------*/
      const analyzeContent = { text: text, features: params.features };
      service.analyze(analyzeContent, (err, response) => {
      /*------END OF SECOND CODE SNIPPET WE ADDED AND CHANGED--------*/      
        if (err) {
          reject(err.message);
        } else {
          resolve(response);
