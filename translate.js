...
function main(params) {
    ...
    /*------START OF NEW CODE SNIPPET WE ADDED------*/
    let language = params.languages[0].language;
    
    if(language === 'en' ){
        console.log("Language is English! No need to make translation. Sending it to NLU...");
        params.isEnglish = true;
        return params;
    }
    console.log("Language is not English! Need to make translation. Sending it to Language Translator...");
    
    params.source = language;
    params.target = 'en';
    /*------END OF NEW CODE SNIPPET WE ADDED--------*/
